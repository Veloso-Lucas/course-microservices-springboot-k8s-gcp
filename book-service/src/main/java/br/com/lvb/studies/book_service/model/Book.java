package br.com.lvb.studies.book_service.model;
...
public class Book implements Serializable {
    ...
    public Book(Long id, String author, String title, LocalDateTime launchDate, Double price, String currency, String environment) {
        this.id = id;
        this.author = author;
        this.title = title;
